...
const Settings = mongoose.model(config.DB_NAME || 'Settings', settingsSchema);

async function connectdb() {
    try {
        await mongoose.connect('mongodb://mongo:CkqStGNAqzOSsPTHtvFkolvTlDuhcjgz@mongodb.railway.internal:27017');
